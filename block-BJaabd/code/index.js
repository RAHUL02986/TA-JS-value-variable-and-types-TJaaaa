...
alert(`the value of sum id ${sum1}`);
...
}else(`The final value is nagitive`);
...
// [Your code goes here]
let firstnum = +prompt("enter first value for opration");
let secondnum = +prompt("enter second value of oprationn");
let operation = +prompt(" enter an opration(Add , sub, mul, div)");
